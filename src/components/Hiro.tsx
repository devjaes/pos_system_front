          ...
          <div className="flex items-center justify-center w-full px-6 py-8 lg:h-[32rem] lg:w-1/2">
            <div className="max-w-xl">
              ...
              <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 lg:text-base">
                Gestione las ventas, el inventario y a los empleados con total
                facilidad. Interactúe con los clientes y aumente así sus
                ingresos. Aunque tenga una o múltiples tiendas, nuestras
                herramientas cubrirán toda necesidad que tenga en su negocio.
              </p>

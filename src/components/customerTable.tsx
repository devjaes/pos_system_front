...
import { handleCreateCustomer, handleDeleteCustomer, handleGetAllCustomers } from '@/store/api/customerApi';
        ...
        <>
            <div className='flex flex-col gap-6'>
                ...
                <div className='flex gap-4 justify-between'>
                    ...
                    <Button label="Agregar Cliente" severity="info" raised icon="pi pi-plus" className="p-button-success" onClick={() => setAddVisible(true)} />
                </div>
                <DataTable

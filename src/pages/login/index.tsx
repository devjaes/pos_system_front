    ...
    <div className='w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800'>
      <div className='px-6 py-4'>
        <div className=' justify-center mx-auto'>
          ...
          <div>
          <h3 className='mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200'>MyPos System</h3>
          <p className='mt-1 text-center text-gray-500 dark:text-gray-400'>Inicio de sesión</p>
          </div>
          <form >
